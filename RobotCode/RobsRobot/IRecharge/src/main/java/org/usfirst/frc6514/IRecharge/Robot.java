...
public class Robot extends TimedRobot {
    ...
    NetworkTableEntry autoselection;


    public static OI oi;
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public static DriveSystem driveSystem;
    public static FuelSystem fuelSystem;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.setDefaultOption("Auto1", new Auto1());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        chooser.addOption("Auto2", new Auto2());
        chooser.addOption("Auto3", new Auto3());
        ...
        autoselection = networkTable.getEntry("AutoSelection");
    ...
    public void teleopInit() {
        ...
        //Temp for testing
        xEntry.setDouble(100);
        yEntry.setDouble(200);
        //Temp for testing
    }
