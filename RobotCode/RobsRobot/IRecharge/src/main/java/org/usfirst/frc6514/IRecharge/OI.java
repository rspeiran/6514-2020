...
public class OI {
    ...
    public JoystickButton btsShootStop;
    ...
    public OI() {
        ...
        btsShootStop = new JoystickButton(joystickShooter, 1);
        btsShootStop.whenReleased(new ShootStop());
        btsShoot = new JoystickButton(joystickShooter, 1);
        btsShoot.whenPressed(new Shoot());
