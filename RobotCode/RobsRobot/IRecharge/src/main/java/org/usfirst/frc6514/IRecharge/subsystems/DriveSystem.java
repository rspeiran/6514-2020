...
public class DriveSystem extends Subsystem {
    ...
    public DriveSystem() {
        ...
        differentialDrive1 = new DifferentialDrive(leftDriveSpeedController, rightDriveSpeedController);
    ...
    public void periodic() {
        ...
        if (!RobotState.isAutonomous())
        {
            if (UserDriveStyle == DriveStyle.Tank){
                robotDrive.tankDrive(Robot.oi.joystickDriver.getX(), Robot.oi.joystickDriver.getY());
            }
            else if (UserDriveStyle == DriveStyle.Arcade){ 
                robotDrive.arcadeDrive(Robot.oi.joystickDriver.getX(), Robot.oi.joystickDriver.getX());
            }
