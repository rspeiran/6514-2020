    ...
    public void periodic() {
        ...
        if (!RobotState.isAutonomous())
        {
            if (UserDriveStyle == DriveStyle.Tank){
                differentialDrive.tankDrive(Robot.oi.joystickDriver.getY(), Robot.oi.joystickDriver.getY());
            }
            else if (UserDriveStyle == DriveStyle.Arcade){ 
                differentialDrive.arcadeDrive(Robot.oi.joystickDriver.getRawAxis(5), Robot.oi.joystickDriver.getX());
            }
