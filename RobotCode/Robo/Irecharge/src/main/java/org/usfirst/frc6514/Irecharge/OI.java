...
public class OI {
    ...
    public JoystickButton btnElevatorShooterDown;
    public JoystickButton btnElevatorShooterDownStop;
    ...
    public OI() {
        ...
        btnElevatorShooterDownStop = new JoystickButton(joystickShooter, 1);
        btnElevatorShooterDownStop.whenReleased(new ElevatorStop());
        btnElevatorShooterDown = new JoystickButton(joystickShooter, 1);
        btnElevatorShooterDown.whenPressed(new ElevatorMoveDown());
